...
// FUNÇÕES FIRESTORE E RENDERIZAÇÃO COMPLETA
...
// RENDER, MODAL, ADICIONAR, EDITAR, EXCLUIR, PONTO, CALCULAR HORAS
// ... (mesmo código que você já tinha para renderAll, renderColaboradores, registrarPonto, excluirPonto, removerColab, calcularHoras, download Excel)

// PONTO DE SAÍDA AUTOMÁTICO
function baterSaidaAutomatica() {
  const agora = new Date();
  const horaAtual = agora.getHours();
  const minutoAtual = agora.getMinutes();
  if (horaAtual === ** && minutoAtual === *) { // exemplo: 20:00
